...
echo "read_file -type vhdl $PWD/../../bsc_lightlock/hdl/apb_lightlock.vhd" >> /tmp/$N/$N.prj
echo "read_file -type vhdl $PWD/../../bsc_lightlock/hdl/staggering/staggering_handler.vhd" >> /tmp/$N/$N.prj
echo "read_file -type vhdl $PWD/../../bsc_lightlock/hdl/lightlock_pkg.vhd" >> /tmp/$N/$N.prj
